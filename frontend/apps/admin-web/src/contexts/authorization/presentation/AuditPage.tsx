...
import { Badge, Button, Card, ErrorNotice, PageHeader, formatTime } from "../../../shared/presentation/ui";
import { authorizationService } from "../application/services";

export function AuditPage() {
  const query = useQuery({ queryKey: ["audit-events"], queryFn: authorizationService.listAuditEvents });
