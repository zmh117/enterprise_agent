...
- 在导入侧明确离线来源与受信 ONES 实例/Team 的关系，系统生成确认记录摘要，区分 CONFIRMED 与历史 VERIFIED；删除 Web 的来源确认/核验手工表单，不要求证明摘要或 RUNNING Job ID。Web 只读继承数据集的唯一有效来源；保留离线数据身份，未知来源不得自动发布，KB＋本人 ONES 逐次双重校验不变。
