...
- [x] 1.1 收集并脱敏固化钉钉群聊、私聊、文本、图片和文件Stream payload夹具，确认稳定会话类型、机器人身份和媒体下载字段
...
- [x] 6.4 运行迁移、完整测试、ruff、mypy、Compose配置、OpenSpec严格校验及MinIO/附件worker运行时烟测
- [x] 6.5 使用真实脱敏钉钉群聊和私聊验证连续追问、附件快速ACK、WAITING_INPUT转换、原会话投递及跨范围无泄漏
