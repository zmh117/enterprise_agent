# dingtalk-mcp Specification

## Purpose
定义部署固定的钉钉业务 MCP、当前用户身份解析、创建本人待办 Provider 合同、平台凭据隔离和统一操作审计边界。

## Requirements

<!-- Integrated from change: `add-governed-dingtalk-mcp-mvp/specs/dingtalk-mcp` -->
