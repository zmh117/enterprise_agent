# continuous-agent-conversation Specification

## Purpose
TBD - created by archiving change add-continuous-dingtalk-multimodal-conversations. Update Purpose after archive.
## Requirements
