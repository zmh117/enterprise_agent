# multi-provider-external-identity-management Specification

## Purpose
TBD - created by archiving change connect-admin-auth-and-external-identity-management. Update Purpose after archive.
## Requirements
