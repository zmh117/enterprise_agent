# business-application-execution-policy Specification

## Purpose
TBD - created by archiving change enforce-business-application-execution-policy. Update Purpose after archive.
## Requirements
