# multi-dialect-schema-inspection Specification

## Purpose
TBD - created by archiving change add-schema-inspector-oracle-sqlserver-preview. Update Purpose after archive.
## Requirements
