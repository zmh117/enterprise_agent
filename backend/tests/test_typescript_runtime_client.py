    ...
    return (
        TypeScriptAgentRuntimeClient(
            settings=RuntimeClientSettings(
                ...
                ones_mcp_url="http://ones-mcp-server:9101/mcp",
                data_mcp_url="http://data-mcp-server:9102/mcp",
            ...
            mcp_token_issuer=McpTokenIssuer(MCP_KEY),
            transport=transport,
...
def test_worker_builds_exact_request_and_validates_ndjson_terminal() -> None:
    ...
    assert mcp_claims["scopes"] == ["ones.work_items.search"]
