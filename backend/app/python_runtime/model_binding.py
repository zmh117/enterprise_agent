...
class PythonModelBindingResolver:
    ...
    def resolve(self, revision_id: str, config_hash: str) -> ResolvedPythonModelBinding:
        ...
        binding = ModelRuntimeBinding(
            ...
            default_opus_model=str(config["default_opus_model"] or config["model"]),
            default_sonnet_model=str(config["default_sonnet_model"] or config["model"]),
            default_haiku_model=str(config["default_haiku_model"] or config["model"]),
            subagent_model=str(config["subagent_model"] or config["model"]),
