...
_BUSINESS_CAPABILITY_NAMES_ZH = {
    ...
    "dingtalk_get_aitable_supported_search_filters": "查看 AI 表格搜索筛选说明",
    "dingtalk_get_aitable_supported_field_info": "查看 AI 表格字段类型说明",
    "dingtalk_get_aitable_record_values_format": "查看 AI 表格记录值格式",
    ...
    "dingtalk_create_aitable_sheet": "创建 AI 表格数据表",
    "dingtalk_update_aitable_sheet": "更新 AI 表格数据表",
    "dingtalk_create_aitable_field": "创建 AI 表格字段",
    "dingtalk_update_aitable_field": "更新 AI 表格字段",
    "dingtalk_insert_aitable_records": "新增 AI 表格记录",
    "dingtalk_update_aitable_records": "更新 AI 表格记录",
    "dingtalk_send_message_to_group_by_robot": "向当前钉钉来源群发送机器人消息",
    "dingtalk_batch_send_message_to_users_by_robot": "批量发送用户机器人消息",
    ...
    "ones_search_projects": "搜索 ONES 项目",
    "ones_list_project_sprints": "查看 ONES 项目迭代",
    ...
    "ones_query_work_items_with_custom_options": "查询 ONES 自定义条件工作项",
    ...
    "ones_query_test_cases": "查询 ONES 测试用例",
    "ones_get_test_case_detail": "查看 ONES 测试用例详情",
    "task_workspace_get": "查看任务工作区",
    "task_workspace_list_files": "查看工作区文件",
    "task_workspace_search_files": "搜索工作区文件",
    "file_get_metadata": "查看文件元数据",
    "file_prepare_materialization": "准备文件受控物化",
    "file_create_commit_intent": "提交文件版本",
    "file_retain_version": "保留文件版本",
    "file_deliver_version": "交付文件版本",
}
