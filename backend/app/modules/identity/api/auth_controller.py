...
def _principal_payload(principal: Any, authorization: Any) -> dict[str, Any]:
    checks = {
        ...
        "user_sessions_revoke": ("user_session", "*", "revoke"),
        "roles_read": ("role", "*", "read"),
        "roles_manage": ("role", "*", "manage"),
        "roles_simulate": ("role_authorization", "*", "simulate"),
        "identities_read": ("identity", "*", "read"),
        ...
        "agents_read": ("agent", "*", "read"),
        "agents_manage": ("agent", "*", "edit"),
        "applications_read": ("business_application", "*", "read"),
        "applications_manage": ("business_application", "*", "edit"),
        "applications_publish": ("business_application", "*", "publish"),
        "applications_activate": ("business_application", "*", "activate"),
        "channels_read": ("channel_connector", "*", "read"),
        "channels_manage": ("channel_connector", "*", "manage"),
        "channels_test": ("channel_connector", "*", "test"),
        "jobs_read": ("agent_job", "*", "read"),
        "jobs_debug": ("agent_job", "*", "debug"),
        "jobs_cancel": ("agent_job", "*", "cancel"),
        "mcp_servers_read": ("mcp_server", "*", "read"),
        "mcp_servers_check": ("mcp_server", "*", "check"),
        "mcp_tools_read": ("mcp_tool", "*", "read"),
        "mcp_tools_manage": ("mcp_tool", "*", "manage"),
        "mcp_resources_read": ("mcp_resource", "*", "read"),
        "mcp_resources_manage": ("mcp_resource", "*", "manage"),
        "secrets_read": ("secret", "*", "read"),
        "secrets_manage": ("secret", "*", "manage"),
