# Generated from contracts/agent-runtime/v1.5. Do not edit.
...
CONTRACT_SCHEMA_SHA256 = "317b475b7f4c15c727e6b2a4d557e28b4ea4b17821608f931046fbabf5cdf5a7"
...
class AgentExecutionRequestV15(TypedDict):
    protocol_version: Literal["1.5"]
    runtime_kind: RuntimeKind
...
class AuditChunk(TypedDict):
    encoding: Literal["base64+json"]
    chunk_index: int
    chunk_count: int
    sha256: Sha256Digest
    content: str
...
class TerminalResult(TypedDict):
    ...
    audit_sha256: NotRequired[Sha256Digest]
    audit_chunk_count: NotRequired[int]
