    ...
    if file_job:
        ...
        restrictions.extend(
            [
                ...
                "File MCP and file_manifest timestamps (source_received_at, version_created_at, observed_at, representation_created_at, expires_at) are Asia/Shanghai RFC 3339 with offset +08:00. When speaking to the user, use that clock; do not treat a Z or +00:00 wall-clock as Beijing time. For relative upload-time requests, compare source_received_at with the service-provided observed_at; do not treat version_created_at or a generic created_at as upload time.",
