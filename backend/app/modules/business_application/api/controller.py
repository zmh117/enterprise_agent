...
class RevisionResponse(BaseModel):
    ...
    document_processing_profile_code: Literal["NONE", "docling-layout-ocr-v2"] = "NONE"
    document_processing_status: Literal["DISABLED", "CONFIGURED_UNAVAILABLE", "READY"] = "DISABLED"
...
class PublicationResponse(RuntimeStateResponse):
    ...
    document_processing_profile_source: Literal["publication_snapshot"] = "publication_snapshot"
    document_processing_status: Literal["DISABLED", "CONFIGURED_UNAVAILABLE", "READY"] = "DISABLED"
    document_processing_reason_code: str = "profile_disabled"
    task_file_features: TaskFileFeaturesResponse = Field(default_factory=TaskFileFeaturesResponse)
