...
class TriggerValidator:
    ...
    def validate(
        ...
        assigned_tools = (
            sorted(self.agent_config_service.repository.publication_tools(agent_publication_id))
        ...
        allowed_tools = [
            tool_name for tool_name in assigned_tools if tool_name in enabled_read_only_tools
        ]
        summary = {
