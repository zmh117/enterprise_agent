...
from app.modules.mcp_tool_runtime.infrastructure.loki_envelope import safe_error_text
from app.modules.mcp_tool_runtime.infrastructure.loki_client import (
    build_logql,
...
class HttpLokiClient:
    ...
    def labels(
        ...
        *,
        ...
        return ToolResponse(
            ...
            truncated=truncated,
            metadata={"source": "tool-mcp-loki-diagnostics"},
        )
    ...
    def probe(
        ...
        *,
        ...
        result.metadata.setdefault("source", "tool-mcp-loki-diagnostics")
