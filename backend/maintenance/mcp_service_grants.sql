...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE
  ...
  permission_policy, platform_access_grant, rbac_role, rbac_user_role,
  rbac_role_admin_capability, rbac_role_application_access,
  rbac_role_application_capability, rbac_role_application_scope,
  ...
  business_application_revision_target, business_application_revision_trigger,
  business_application_publication, business_application_publication_target,
  business_application_deployment, business_application_active_route,
  business_application_runtime_state, agent_channel_binding,
  ...
  platform_config_audit, mcp_tool_publication, mcp_job_subject_snapshot,
...
GRANT SELECT ON TABLE
  ...
  permission_policy, platform_access_grant, rbac_role, rbac_user_role,
  rbac_role_application_access, rbac_role_application_scope,
  agent_definition, agent_revision, agent_publication, agent_skill_binding,
  agent_workflow_template, agent_workflow_node, agent_workflow_edge,
  agent_workflow_publication, business_application,
  business_application_revision, business_application_revision_delivery,
  ...
  mcp_tool_publication, mcp_resource, mcp_resource_revision,
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE
  ...
  mcp_tool_call_provenance, mcp_tool_call_attempt
  TO enterprise_agent_worker;
