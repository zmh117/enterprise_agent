...
from services.file_service.internal_http import bearer_token, denial_on_app_error, safe_result
...
class FileStreamingRoutes:
    ...
    @denial_on_app_error
    async def delivery_content(self, request: Request) -> StreamingResponse:
