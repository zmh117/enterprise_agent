...
class DocumentProcessingOperations(Protocol):  # noqa: PLR0904
    def acquire_docling_slot(
        self, *, owner_kind: str, owner_id: str, worker_instance_id: str, service_principal_id: str
    ) -> dict[str, Any]: ...
    ...
    def upload_picture_asset(
        self, *, transfer_id: str, upload_token: str, stream: Any, media_type: str
    ) -> dict[str, Any]: ...
    ...
    def claim_picture_item(
        self, *, picture_item_id: str, claim_token: str, claim_expires_at: str
    ...
    def mark_picture_submitted(
        self, *, picture_item_id: str, external_task_id: str
    ) -> dict[str, Any]: ...
    ...
    def retry_picture_item(
        self, *, picture_item_id: str, error_code: str, delay_seconds: int
    ) -> dict[str, Any]: ...

    def prepare_picture_result_transfer(
        self, *, picture_item_id: str, expected_size_bytes: int, expected_sha256: str
    ) -> dict[str, Any]: ...
