...
RUNTIME_SANDBOX_WORK_OUTPUT_FILE_LIMIT = 80
RUNTIME_SANDBOX_TMP_FILE_LIMIT = 8
RUNTIME_SANDBOX_FILE_LIMIT = 128
RUNTIME_SANDBOX_READINESS_MINIMUM_BYTES = 512 * MIB
RUNTIME_SANDBOX_DEFAULT_CAPACITY_BYTES = 512 * MIB
...
def run(root: Path) -> dict[str, object]:
    ...
    maximum_workspace = _run_scenario(
        ...
        (
            *((4 * MIB,) * RUNTIME_SANDBOX_INPUT_FILE_LIMIT),
            *((4 * MIB,) * RUNTIME_SANDBOX_WORK_OUTPUT_FILE_LIMIT),
            *((4 * MIB,) * RUNTIME_SANDBOX_TMP_FILE_LIMIT),
        ),
    )
