...
| TXT/LOG/Markdown扩展名、MIME、UTF-8、BOM、NUL、15 MiB | `test_text_format_policy.py`, Python shared fixture, `test_file_commit_streaming.py` |
| LOG 写入、改名、Commit与旧Publication/schema漂移 | File Service、Manifest、Python Runtime contract tests |
| 路径逃逸、符号链接、特殊设备、容量、残留清理 | Python Job Sandbox tests |
