...
6. **历史记录**：明确标记为“已完成迁移/退役记录”的 operation 与 `archive/` 仅用于审计，不得按当前操作手册执行。

## 当前架构

- [Admin Web 当前实现](architecture/admin-web-mvp.md)
...
- [统一身份 ONES MCP](architecture/identity-aware-ones-mcp.md)
